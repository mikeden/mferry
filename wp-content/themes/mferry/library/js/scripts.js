...
if (!Modernizr.svg) {
  $("a.search img").attr("src", "");
  $("a.cart img").attr("src", "");
  $("a.search").append("<i class='fa fa-search fa-lg2' aria-hidden='true'></i>");
  $("a.cart").append("<i class='fa fa-shopping-cart fa-lg2' aria-hidden='true'></i>");
}
